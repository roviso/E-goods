          ...
          <div class="panel panel-default"><!-- panel panel-default Begin -->
             ...
             <div class="panel-heading"><!-- panel panel-default Begin -->
                 ...
                 <h3 class="panel-title"><!-- panel-title Begin -->
                     ...
                     <i class="fa fa-plus-circle"></i> Insert Post
                 ...
                 <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                     ...
                     <div class="form-group"><!-- form-group Begin -->
                       ...
                       <div class="col-md-6"><!-- col-md-6 Begin -->
                           ...
                           <input name="owner_id" type="text" class="form-control" required>
  ...
  if(isset($_POST['submit'])){
    ...
    if($imageProcess == 0){
      echo"<<script>
        ...
        values ('$owner_id','$good_cat',NOW(),'$good_title','domi_$resizeFileName1.$fileExt1','domi_$resizeFileName2.$fileExt2','domi_$resizeFileName3.$fileExt3','$good_price','$good_keywords','$good_desc')";
